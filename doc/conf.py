...
ABOUT_FILE = TOPLEVEL_DIR / "plofeld" / "__init__.py"
...
latex_documents = [
    (master_doc, "plofeld.tex", "plofeld Documentation", "JoschD", "manual"),
]
...
man_pages = [(master_doc, "plofeld", "plofeld Documentation", [author], 1)]
